...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <!-- Header -->
        <div style="background-image: url(../admin/assets/img/theme/mrj.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <a href="orders.php" class="btn btn-outline-success">
                                <i class="fas fa-plus"></i> <i class="fas fa-shopping-bag"></i>
                                Make A New Order
                            </a>
                        </div>
