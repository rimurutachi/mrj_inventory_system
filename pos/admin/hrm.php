...
<body>
  ...
  <div class="main-content">
    ...
    ?>
    <!-- Header -->
    <div style="background-image: url(assets/img/theme/mrj.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <a href="add_staff.php" class="btn btn-outline-success"><i class="fas fa-user-plus"></i> Add New Employee</a>
            </div>
